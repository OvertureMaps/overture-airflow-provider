...
_LAZY_IMPORTS = {
    ...
    "submit_databricks_job": ("_databricks", "submit_databricks_job"),
    "complete_databricks_job": ("_databricks", "complete_databricks_job"),
    "submit_glue_job": ("_glue", "submit_glue_job"),
    "complete_glue_job": ("_glue", "complete_glue_job"),
